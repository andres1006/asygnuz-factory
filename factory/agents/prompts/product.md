...
- `tasks/current-gate.txt` y, si necesitás orientación rápida de rol/prompt: `./scripts/session-hint.sh` (mapa canónico en `factory/agents/gate-role-map.md` en la fábrica).
